...
void printDiagnostics() {
	...
	Serial.printf(
	    ...
	    Strata::toString(diag.cleanupQueueStorageRegion),
	    Strata::toString(diag.cleanupTaskStackRegion)
	);
	...
	if (result) {
		Serial.printf(
		    ...
		    Strata::toString(jobDiag.requestedStackPlacement),
		    Strata::toString(jobDiag.stackRegion)
		);
	} else {
